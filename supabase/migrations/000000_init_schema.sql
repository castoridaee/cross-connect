...
CREATE TABLE IF NOT EXISTS public.profiles (
    ...
    is_hard_shadowbanned BOOLEAN DEFAULT false,
    shadowban_total INTEGER DEFAULT 0,
...
BEGIN
    ...
    VALUES (new.id, candidate_username, COALESCE(new.raw_user_meta_data->>'locale', 'en-US'), COALESCE(new.is_anonymous, false));
